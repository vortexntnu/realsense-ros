...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.enable_auto_white_balance', 'default': 'true', 'description': 'enable/disable white balance for color image'},
                           {'name': 'color_qos',                     'default': 'SENSOR_DATA', 'description': 'QoS profile for color image topic [SYSTEM_DEFAULT, DEFAULT, SENSOR_DATA]'},
                           {'name': 'enable_depth',                 'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'enable_infra',                 'default': 'false', 'description': 'enable infra0 stream'},
                           {'name': 'enable_infra1',                'default': 'false', 'description': 'enable infra1 stream'},
                           {'name': 'enable_infra2',                'default': 'false', 'description': 'enable infra2 stream'},
                           {'name': 'depth_qos',                    'default': 'SENSOR_DATA', 'description': 'QoS profile for depth image topic [SYSTEM_DEFAULT, DEFAULT, SENSOR_DATA]'},
                           ...
                           {'name': 'depth_module.emitter_enabled', 'default': 'false', 'description': 'enable/disable depth emitter'},
                          ]
